      ...
      <div class="flex flex-col md:w-1/2">
        ...
        <div class="flex flex-col mb-6 ml-16">
          ...
          <p class="text-black text-base md:text-lg font-normal font-['Instrument Sans'] max-w-md mt-6">
            We offer a secure and comfortable space where your pets can relax while you're away. With personalized care and a welcoming environment, we ensure your pets stay happy and stress-free during their time with us.
          </p>
        </div>
        <!-- Large Square Image -->
        <div class="w-64 h-64 ml-16">
          <img
            src="{{ asset('images/Thiết kế chưa có tên (4) 2.png') }}"
            alt="Pet Image"
