  ...
  <div class="flex flex-col md:flex-row items-center gap-8 bg-primary-light rounded-lg p-8 mb-12 mt-16">
    <div class="md:w-2/3">
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 font-['Otomanopee One']">
        Health care and psychological counseling
      </h1>
    </div>
  ...
  <div class="bg-[#e6e2ff] rounded-lg p-8 mb-12">
    <div class="flex flex-col md:flex-row gap-8">
      ...
      <div class="flex flex-col md:w-1/2">
        ...
        <div class="flex flex-col mb-6 ml-16">
          ...
          <p class="text-black text-base md:text-lg font-normal font-['Instrument Sans'] max-w-md mt-6">
            We provide comprehensive health care and psychological counseling to keep your pets healthy and happy. From medical check-ups to behavioral support, we ensure their well-being every step of the way.
          </p>
        </div>
        <!-- Large Square Image -->
        <div class="w-64 h-64 ml-16">
          <img
            src="{{ asset('images/Thiết kế chưa có tên 2.png') }}"
            alt="Pet Image"
      ...
      <div class="md:w-1/2">
        <div class="space-y-4">
          @foreach ([ 
            ['title' => "Regular health check-ups", 'price' => "$13"],
            ['title' => "At-home medical exams", 'price' => "$25"],
            ['title' => "At-home vaccinations", 'price' => "$20"],
            ['title' => "Special pet care", 'price' => "$40"],
            ['title' => "Remote consultations", 'price' => "$10"],
            ['title' => "Nutrition counseling", 'price' => "$15"],
            ['title' => "Vaccinations", 'price' => "$18"],
            ['title' => "Psychological and behavioral counseling", 'price' => "$22"],
            ['title' => "Disease treatment", 'price' => "$25 - $60"],
          ] as $service)
