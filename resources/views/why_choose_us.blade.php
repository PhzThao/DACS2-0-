        ...
        <div class="relative pt-5">
            ...
            <div class="absolute inset-0 flex items-center justify-center z-10">
                <div class="flex items-center justify-center w-1/3">
                    <img src="{{ asset('images/why-choose-us-banner 1.png') }}" alt="Happy pets"
                        class="w-2/3 h-56 md:w-80 md:h-80 object-cover">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8 md:gap-16 relative z-20">
                ...
                @foreach ($reasons as $index => $reason)
                    <div
                        class="flex flex-col items-center text-center {{ $index % 2 == 0 ? 'justify-start' : 'justify-end' }} h-64 md:h-96">
