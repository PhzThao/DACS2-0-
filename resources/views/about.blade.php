<section class="py-8 md:py-16 bg-[#ffd9d9]">
    <div class="container mx-auto px-4">
        <h2 class="text-[#d41717] text-xl md:text-2xl font-normal font-['Instrument Sans'] mb-2 md:mb-4 text-center">ABOUT US</h2>
        <h3 class="text-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal font-['Otomanopee One'] mb-8 text-center">Our Journey to HappyPet<br>A Passion for Pets</h3>
