    ...
    <div class="container mx-auto mt-10 relative z-10">
        <div class="flex welcome-container flex-col md:flex-row items-center">
            <div class="w-full ml-10 md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
                <h2 class="text-black text-lg md:text-xl font-normal font-['Instrument Sans'] mb-2 md:mb-4 font-instrument">
                    WELCOME TO HAPPYPET
                </h2>
                <h1 class="text-[#171650] text-3xl md:text-4xl lg:text-5xl font-normal font-['Otomanopee One'] mb-4 md:mb-6 font-otomanopee">
                    The Best Care for Your Best Friend
                </h1>
                <p class="text-black text-base md:text-lg font-normal font-['Instrument Sans'] mb-6 md:mb-8 font-instrument">
