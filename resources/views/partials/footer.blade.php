    ...
    <div class="container mx-auto flex justify-between" style="margin-left: 20px;">
        <div class="w-1/3">
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/favicon 2.png') }}" alt="HappyPet Logo" class="w-10 h-[44.19px]">
            ...
            <div class="flex space-x-4 mt-8">
                ...
                <a href="#" class="transform transition-transform duration-300 hover:scale-110">
                    <div class="w-[47px] h-[47px] bg-[#988f8f] rounded-full border-2 border-black flex items-center justify-center hover:shadow-xl">
                        <img src="{{ asset('images/youtube-symbol 1.png') }}" alt="YouTube" class="w-[17px] h-[17px]">
                    </div>
                </a>
            </div>
        </div>
        <div class="w-1/3">
            ...
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/pin.png') }}" alt="Location" class="w-5 h-5 mr-4">
            ...
            <div class="flex items-center mb-4">
                <img src="{{ asset('images/phone-call.png') }}" alt="Phone" class="w-5 h-5 mr-4">
                <p class="text-black text-lg font-normal font-['Instrument Sans']">9999 999 999</p>
            </div>
            <div class="flex items-center">
                <img src="{{ asset('images/email.png') }}" alt="Email" class="w-5 h-5 mr-4">
                <p class="text-black text-lg font-normal font-['Instrument Sans']">thaonp.23ite@vku.udn.vn</p>
            </div>
        </div>
        <div class="w-1/3">
            <img src="{{ asset('images/dog-vector 1.png') }}" alt="Footer Image" class="w-[281px] h-[311px]">
        </div>
    </div>
</footer>